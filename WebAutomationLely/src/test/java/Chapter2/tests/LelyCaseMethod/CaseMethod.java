package Chapter2.tests.LelyCaseMethod;
...
public class CaseMethod extends BasePage {
    ...
    public void CheckHappy() {
        ...
        CaseMethod.tryCatch(2000);
        BasePage.happyControlAtPage(Page.PAGE1);
        BasePage.happyControlAtPage(Page.PAGE2);
        BasePage.happyControlAtPage(Page.PAGE3);
        BasePage.happyControlAtPage(Page.PAGE4);
    }
